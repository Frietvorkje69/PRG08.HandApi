...
//Buttons
const addL = document.querySelector("#l");
const addO = document.querySelector("#o");
const addI = document.querySelector("#i");
const classify = document.querySelector("#classify");
// const train = document.querySelector("#train");

//Event Listeners
addL.addEventListener("click", () => learnL());
addO.addEventListener("click", () => learnO());
addI.addEventListener("click", () => learnI());
